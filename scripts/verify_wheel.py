...
REQUIRED_MEMBERS = {
    "oatutor_council/prompts/initial_auditor.v8.md",
    "oatutor_council/prompts/writer.v7.md",
    "oatutor_council/prompts/known_issue_reviewer.v5.md",
    "oatutor_council/prompts/independent_reviewer.v7.md",
    "oatutor_council/prompts/adjudicator.v1.md",
    "oatutor_council/prompts/final_verifier.v2.md",
    "oatutor_council/prompts/_shared/curation_rules.v3.md",
