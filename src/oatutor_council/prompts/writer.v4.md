...
fractions and constants. A standalone relabel needs a deterministic mismatch or an
explicit curator instruction; an Answer and answerType may still change together when one
coordinated semantic correction requires both.
